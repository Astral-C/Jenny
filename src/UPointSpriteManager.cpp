...
void UPointSpriteManager::Init(int BillboardResolution, int BillboardImageCount) {
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(UPointSprite), (void*)offsetof(UPointSprite, Position));
    glEnableVertexAttribArray(1);
    glVertexAttribIPointer(1, 1, GL_UNSIGNED_INT, sizeof(UPointSprite), (void*)offsetof(UPointSprite, Texture));
    glEnableVertexAttribArray(2);
    glVertexAttribIPointer(2, 1, GL_UNSIGNED_INT, sizeof(UPointSprite), (void*)offsetof(UPointSprite, SpriteSize));
    glEnableVertexAttribArray(3);
    glVertexAttribIPointer(3, 1, GL_UNSIGNED_INT, sizeof(UPointSprite), (void*)offsetof(UPointSprite, Flip));
...
void UPointSpriteManager::Draw(USceneCamera *Camera) {
    ...
    glBindBuffer(GL_ARRAY_BUFFER, mVbo);
    glBufferData(GL_ARRAY_BUFFER, sizeof(UPointSprite) * mBillboards.size(), mBillboards.data(), GL_DYNAMIC_DRAW);
    glBindBuffer(GL_ARRAY_BUFFER, 0);
